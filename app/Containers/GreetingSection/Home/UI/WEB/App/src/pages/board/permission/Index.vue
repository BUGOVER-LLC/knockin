...
import DeleteDialog from '@/pages/board/permission/iframes/DeleteDialog.vue';
import routesNames from '@/router/routesNames';
import { GetRolePaginateModel } from '@/services/api/Model/IGetRolePaginateModel';
...
import FormPermissionDialog from '@/pages/board/permission/iframes/FormPermissionDialog.vue';
