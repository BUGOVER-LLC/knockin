...
<template>
    <div style="padding: 0; margin: 0">
        <v-container class="d-flex d-inline-block justify-center">
            <div style="max-width: 600px; min-width: 400px">
                <v-toolbar color="primary" dark>
                    <v-toolbar-title
                        v-text="$tc('words.available', 2) + ' ' + $tc('menu.permissions', 2).toLowerCase()"
                    />
                </v-toolbar>
                <v-list subheader>
            ...
            <div class="d-flex flex-md-column justify-center align-center mr-6 ml-6">
                ...
                <v-btn class="rounded-lg" color="primary" @click="passAvailable" :disabled="!selectedPermission.length">
            ...
            <div style="max-width: 600px; min-width: 400px">
                <v-toolbar color="primary" dark>
                    <v-toolbar-title
                        v-text="$tc('words.selected', 1) + ' ' + $tc('menu.permissions', 2).toLowerCase()"
                    />
                </v-toolbar>
                                ...
                                <template #default="{ active }">
                                    ...
                                    <v-menu top nudge-left="130" offset-x :close-on-content-click="false">
                                        <template v-slot:activator="{ on, attrs }">
                                            <v-btn color="grey darken-2" dark v-bind="attrs" v-on="on" icon text>
        ...
        <div class="d-flex align-end justify-end mt-3">
            <v-btn v-text="buttonText" @click="emitSelected" outlined color="primary" />
        </div>
    </div>
</template>
