...
namespace Containers\AuthSection\Oauth\Models;

use App\Core\Enum\OauthClientType;
use App\Domain\Oauth\Data\Repository\OauthAccessTokenRepository;
use App\Domain\Oauth\Data\Repository\OauthClientRepository;
 ...
 * @mixin Eloquent
 */
#[ModelEntity(repositoryClass: OauthClientRepository::class)]
