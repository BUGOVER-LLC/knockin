...
import { CreateUserInviteModel } from '@/services/api/Model/CreateUserInviteModel';
import { GetUserPaginateModel } from '@/services/api/Model/GetUserPaginateModel';
import { UserEditModel } from '@/services/api/Model/UserEditModel';
import {
    CreateUser,
    DeleteInviteUser,
    EditUser,
...
import { UserEditResponse, UserInvitationsModel, UserModel } from '@/store/models/UserModel';
...
class UserModule extends VuexModule {
    ...
    public async initCheckPSN(psn: number) {
        return await GetUserInfoByPSN(psn);
    }
