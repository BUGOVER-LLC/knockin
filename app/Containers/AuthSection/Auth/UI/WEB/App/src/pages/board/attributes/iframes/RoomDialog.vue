            ...
            <v-window v-model="windowItem" class="mt-3">
                <v-window-item :value="1">
                    <v-data-table hide-default-footer :items="getRooms" :headers="headers">
                        ...
                        <template v-slot:item.roomValue="props">
                        ...
                        <template v-slot:item.roomDescription="props">
                ...
                <v-window-item :value="2">
                    <ValidationObserver ref="roomCreateForm" v-slot="{ invalid, validated, handleSubmit, validate }">
...
import { saveRoomsByAttributeId } from '@/services/api/RoomApi';
...
import RoomModule, { CreateRoom } from '@/store/modules/RoomModule';
...
export default class RoomDialog extends Vue implements OnCreated {
    ...
    public headers = [
        {
            text: this.$t('users.first_name'),
            align: 'start',
            sortable: false,
            value: 'roomName',
        },
        {
            text: this.$t('room.value'),
            align: 'start',
            sortable: false,
            value: 'roomValue',
        },
        {
            text: this.$t('room.description'),
            align: 'start',
            sortable: false,
            value: 'roomDescription',
        },
        {
            text: this.$t('words.delete'),
            align: 'start',
            sortable: false,
            value: 'delete',
        },
    ...
    public async createRoom(validate: Promise<any>) {
