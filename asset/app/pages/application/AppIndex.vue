...
<template>
    <v-app id="inspire">
        ...
        <v-navigation-drawer ref="drawer" v-model="navigation.shown" app width="300">
        ...
        <v-footer app color="transparent" height="72" inset>
            <v-text-field background-color="grey lighten-1" class="rounded-lg" dense flat hide-details solo />
        </v-footer>
    </v-app>
</template>
