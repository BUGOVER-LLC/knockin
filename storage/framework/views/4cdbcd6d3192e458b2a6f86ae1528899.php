...
<?php echo $__env->make('greetingSection@home::units.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<main class="main">
    ...
    <section id="hero" class="hero section">
        <div class="hero-bg">
            <img src="<?php echo e(asset('assets/img/hero-bg-light.webp')); ?>" alt="main-hero">
        </div>
        <div class="container text-center">
            <div class="d-flex flex-column justify-content-center align-items-center">
                <h1>Welcome to <span>QuickStart</span></h1>
                <p data-aos-delay="100">Quickly start your project now and set the stage for
                    success<br></p>
                <div class="d-flex" data-aos-delay="200">
    ...
    <section id="featured-services" class="featured-services section light-background">
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-lg-6" data-aos-delay="100">
                ...
                <div class="col-xl-4 col-lg-6" data-aos-delay="200">
                    <div class="service-item d-flex">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 content" data-aos-delay="100">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-check-circle"></i> <span>Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</span>
                        </li>
                    </ul>
                    <a href="#" class="read-more"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
                </div>

                <div class="col-lg-6 about-images" data-aos-delay="200">
                    <div class="row gy-4">
                        <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="tab-content" data-aos-delay="200">
    ...
    <section id="features-details" class="features-details section">
        ...
        <div class="container">
            ...
            <div class="row gy-4 justify-content-between features-item">
                ...
                <div class="col-lg-5 d-flex align-items-center" data-aos-delay="200">
                    <div class="content">
            ...
            <div class="row gy-4 justify-content-between features-item">
                ...
                <div class="col-lg-6 order-1 order-lg-2" data-aos-delay="200">
    ...
    <section id="services" class="services section light-background">
        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6" data-aos-delay="500">
                ...
                <div class="col-lg-6" data-aos-delay="600">
    ...
    <section id="more-features" class="more-features section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-around gy-4">
                ...
                <div class="features-image col-lg-5 order-1 order-lg-2" data-aos-delay="200">
    ...
    <section id="pricing" class="pricing section">
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4" data-aos-delay="300">
                    <div class="pricing-item">
...
<?php /**PATH /home/vagrant/noix/app/Containers/GreetingSection/Home/UI/WEB/Views//index.blade.php ENDPATH**/ ?>