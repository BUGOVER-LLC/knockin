...
namespace Src\Http\Controllers\Greeting;

use Src\Core\Abstracts\AbstractAction;
use Src\Repositories\WorkspaceRepository;

class GreetingIndexController extends AbstractAction
{
    public function __construct(protected WorkspaceRepository $workspaceContract)
    {
    }
